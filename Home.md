...
* Pre vykreslenie produktového mini banneru použijeme metódu [Ahoj.renderProductBanner](https://github.com/TomasJendek/ahoj-uniapi/wiki/renderProductBanner), kde na vstupe vložíme výsledok predošlého volania - objekt `CalculatedProduct`.
