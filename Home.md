...
* Pre vykreslenie produktového mini banneru použijeme metódu `[renderProductBanner](/renderProductBanner)`, kde na vstupe vložíme výsledok predošlého volania - objekt `CalculatedProduct`.
